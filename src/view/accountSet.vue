  ...
  <div class="account-main bg-part">
    ...
    <div class="clear mb50">
      ...
      <div class="fl ml30">
        ...
        <p class="fColor2 ft14">您的账号安全等级 低，强烈建议开启更多身份验证</p>
        <p class="fColor2 ft14" style="display: none;">您的账号安全等级 低，恭喜您!</p>
      </div>
    </div>
    <ul>
      <li class="extenbox">
        ...
        <div class="fColor1 fr showcode" style="margin:0 20px">
            <span>显示邀请码</span>
